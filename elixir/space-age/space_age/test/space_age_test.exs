defmodule SpaceAgeTest do
  ...
  test "to_minutes" do
    assert SpaceAge.to_minutes(60.0) == 1.0
    assert SpaceAge.to_minutes(120.0) == 2
    assert SpaceAge.to_minutes(180.0) == 3
  end

  test "age on Earth" do
    input = 1_000_000_000
    result = SpaceAge.age_on(:earth, input)
    # require IEx; IEx.pry
    assert_in_delta 31.69, result, 0.005
  end
